...
public class IntakeConstants {
    ...
    public static final double kFlywheelA = 0.02;
    ...
    static {
      ...
      kPivotConfiguration.kP = kPivotP;
      kPivotConfiguration.kI = kPivotI;
      kPivotConfiguration.kD = kPivotD;
      kPivotConfiguration.kG = kPivotG;
      kPivotConfiguration.kV = kPivotV;
      kPivotConfiguration.kA = kPivotA;
      ...
      kFlywheelConfiguration.kP = kFlywheelP;
      kFlywheelConfiguration.kI = kFlywheelI;
      kFlywheelConfiguration.kD = kFlywheelD;
      kFlywheelConfiguration.kV = kFlywheelV;
      kFlywheelConfiguration.kA = kFlywheelA;
      kFlywheelConfiguration.isArm = false;
      kFlywheelConfiguration.withFOC = false;
      kFlywheelConfiguration.isInverted = false;
      kFlywheelConfiguration.maxVelocity = kFlywheelConfiguration.getStandardMaxVelocity(kFlywheelMaxRPM);
      kFlywheelConfiguration.maxAcceleration = kFlywheelConfiguration.maxVelocity/2;
    }
}
